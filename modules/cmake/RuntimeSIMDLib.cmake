function(make_lib_simd_runtime name file)
    ...
    target_sources(${name}_sse_or_arm PUBLIC ${file})

    add_library(${name}_avx STATIC)
    target_sources(${name}_avx PUBLIC ${file})
    ...
    if(WIN32)
        ...
        target_compile_options(${name}_avx PRIVATE -mavx2 -mfma -Wno-unused-command-line-argument)
    endif()

    add_library(${name} STATIC)
    target_link_libraries(${name} PRIVATE ${name}_sse_or_arm ${name}_avx)
endfunction()
