...
npx notarize-cli --file $pkg_dir/BYOD-signed.pkg --bundle-id com.chowdsp.BYOD --asc-provider "$TEAM_ID" --username chowdsp@gmail.com --password "$INSTALLER_PASS"

echo "Building disk image..."
vol_name=Install_BYOD-$app_version
rm -f "$vol_name"
